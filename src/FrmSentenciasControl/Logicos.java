 ...
 * @author bradl
 */
public class Logicos extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Logicos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
