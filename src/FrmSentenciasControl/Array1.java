 ...
 * @author bradl
 */
public class Array1 extends javax.swing.JFrame {
    int tam;
    Arreglos1 func = new Arreglos1();
    ...
    private void initComponents() {
        ...
        lsNumeros.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lsNumerosMouseClicked(evt);
            }
        });
    ...
    private void bAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarActionPerformed
        // TODO add your handling code here:
        int num = Integer.parseInt(tfMultiplo.getText());
        int elemento = Integer.parseInt(tfElemento.getText());
        if (elemento%num == 0){
            listaNum.add(elemento);
            modelo.removeAllElements();
            for(int i = 0; i <= listaNum.size();i++){
                modelo.addElement(listaNum.get(i));
            }
        }else{
    ...
    private void lsNumerosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lsNumerosMouseClicked
        // TODO add your handling code here:
        
    }//GEN-LAST:event_lsNumerosMouseClicked
    ...
    private void bMostrarMayorMenorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bMostrarMayorMenorActionPerformed
        // TODO add your handling code here:
        String max = String.valueOf(Collections.max(listaNum));
        String min = String.valueOf(Collections.min(listaNum));
        tfMayor.setText(max);
        tfMenor.setText(min);
    ...
    private void bMostrarPromedioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bMostrarPromedioActionPerformed
        ...
        for(int i = 0; i <listaNum.size();i++){
            valor = String.valueOf(listaNum.get(i));
    ...
    private void bMostrarMayoresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bMostrarMayoresActionPerformed
        ...
        int prom = suma / arreglo.length;
        for (int k = 0; k <= listaNum.size(); k++){
            valor = String.valueOf(listaNum.get(k));
            elemento = Integer.parseInt(valor);
            if(elemento >= prom){
                models.addElement(listaNum.get(k));
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Array1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
